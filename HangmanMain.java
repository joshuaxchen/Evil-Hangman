 ...
 *
 *   Based on a program by Stuart Reges, modified by Mike Scott and Joshua Chen
 */
...
public class HangmanMain  {
    ...
    private static Set<String> getDictionary() {
        ...
        try {
            ...
            System.out.println("Be sure the dictionary file is in "
                    + "that directory");
            System.out.println("Returning empty set for dictionary.");
        }
    ...
    // dictionary.txt.txt has words from length 2 to 25
    private static void showWordCounts(HangmanManager hangman) {
        // why 25? Should this vary with the dictionary.txt??
